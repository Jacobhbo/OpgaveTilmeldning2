...
using OpgaveTilmeldning.Animals;
using OpgaveTilmeldning.Personer;
...
namespace OpgaveTilmeldning.Code
{
    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            /*Person teacher = new Teacher("John", "Bob", new DateTime(1985, 5, 10), "Lærer");
             Person elev = new Elev("Bob", "Marley", new DateTime(2007, 1, 10), "Elev");

             elev.SayHello();
             teacher.SayHello();

             Console.WriteLine(elev.ShowMyIdentity());
             Console.WriteLine(teacher.ShowMyIdentity());*/
            ...
            while (true)
            {
                Console.Write("First choose an animal (1 for cat, 2 for dog, Q to quit): ");
        ...
        Start:
            ...
            if (tast.ToLower() == "j")
            {
                ...
                Console.WriteLine("\nTilmeldte elever:");
                foreach (Elev elevLoop in tilmeldteElever)
                {
                    string valgtFag = fagListe[valg - 1];
